...
Eigen::Matrix3d reduceUnitCell(std::vector<double> &cell_parameters, Eigen::Matrix3d &transform, bool &total_reduced) {
	...
	// Old axis system
	Eigen::Matrix3d axis_matrix = getCartesianSystem(cell_parameters);
	...
	cell_parameters[3] = acos(new_axis.col(1).dot(new_axis.col(2)) / (new_axis.col(1).norm() * new_axis.col(2).norm())) * 180.f / pi;
	cell_parameters[4] = acos(new_axis.col(0).dot(new_axis.col(2)) / (new_axis.col(0).norm() * new_axis.col(2).norm())) * 180.f / pi;
	cell_parameters[5] = acos(new_axis.col(0).dot(new_axis.col(1)) / (new_axis.col(0).norm() * new_axis.col(1).norm())) * 180.f / pi;
